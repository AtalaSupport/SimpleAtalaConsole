...
This is a 64 bit .NET Framework 4.6.2 console app with minimal Atalasoft references set, written in C#.  
...
This is the C# .NET Framework version of this app. For other languages / targets, please see [SimpleAtalaConsole](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/SimpleAtalaConsole/wiki) for more options
...
```
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/SimpleAtalaConsole.git SimpleAtalaConsole
```
